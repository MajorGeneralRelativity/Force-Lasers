...
public class Force_Lasers_Field_Emitter_Tile_Entity extends TileEntity implements IInventory, IUpdatePlayerListBox{
	...
	public String getName() {
		...
		return("force_lasers_field_emitter");
	}
	...
	public IChatComponent getDisplayName() {
		...
		return new ChatComponentText("force_lasers_field_emitter");
	}
...
public Force_Lasers_Field_Emitter_Tile_Entity() {
	inv = new ItemStack[1];
...
public void update() {
    // Consume coal to generate power

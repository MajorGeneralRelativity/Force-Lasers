...
public class IonTankGUI extends Gui {
private ion_Tank_Tile_Entity tileEntity;
	...
	public IonTankGUI(InventoryPlayer playerInventory, ion_Tank_Tile_Entity tileEntity) {
	...
	//Draw the background
	@Override
    public void drawGuiBackgroundLayer(float renderPartialTicks, int mouseX, int mouseY){
       this.mc.getTextureManager().bindTexture(backgroundimage);
        int x = (this.width - xSize)/2;
        int y = (this.height - ySize)/2;
       drawTexturedModalRect(x, y, 0, 0, xSize, ySize);
       drawTexturedModalRect(195, 55, 1, 1, 100, 10);
    }	
